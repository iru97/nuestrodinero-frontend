...
export const contractCollectionMock: Contract[] = [
  {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/30/pdfs/BOE-B-2020-14447.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/30/pdfs/BOE-B-2020-14448.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/30/pdfs/BOE-B-2020-14449.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/30/pdfs/BOE-B-2020-14450.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/30/pdfs/BOE-B-2020-14451.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/30/pdfs/BOE-B-2020-14453.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/30/pdfs/BOE-B-2020-14454.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      title:
        'Anuncio de formalización de contratos de: Subdirección General de Gestión Económica y Patrimonial. Objeto: EMERGENCIA adquisición ordenadores portátiles para garantizar la modalidad de trabajo no presencial en el Mº del Interior. Expediente: 20-M-071.',
      pdfUrl: '/boe/dias/2020/05/30/pdfs/BOE-B-2020-14455.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/30/pdfs/BOE-B-2020-14456.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/30/pdfs/BOE-B-2020-14457.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'A28472819.',
          address:
            'CAMINO CERRO DE LOS GAMOS 1. POZUELO DE ALARCÓN.  28224. 28224.',
        },
      ],
      details: [
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/30/pdfs/BOE-B-2020-14458.pdf',
    },
  },
];
...
export const contractCollectionMock2: Contract[] = [
  {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14329.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14330.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14331.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14332.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'A79197356.',
          address:
            'CALLE ISAAC NEWTON NUM 11 . TRES CANTOS (MADRID).  28760. 28760.',
        },
      ],
      details: [
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14335.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'B96997432.',
          address: 'Avenida Almansa, 9 - Puerta 19. Ontinyent.  46870. 46870.',
        },
      ],
      details: [
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14336.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14337.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'A79089983.',
          address:
            'c/ Arroyo de Valdebebas 4 4ª planta. Madrid.  28050. 28050.',
        },
      ],
      details: ['48000000 (Paquetes de software y sistemas de información).'],
      sellingDescription: [
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14338.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14339.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14340.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'A28472819.',
          address:
            'Camino de los Gamos 1. Pozuelo de Alarcón ( Madrid).  28224. 28224.',
        },
      ],
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14342.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'A28517308.',
          address:
            'Gremi de Passamaners, Nº 3. Palma de Mallarca.  07009. 07009.',
        },
      ],
      details: [
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14343.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'B30060800.',
          address:
            'Ctra. de Mazarrón, Km 3,6. Sangonera la Verde.  30833. 30833.',
        },
      ],
      details: [
        '50700000 (Servicios de reparación y mantenimiento de equipos de edificios).',
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14344.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'A07077969.',
          address:
            'Josep Antoni de Cabayanes, nº 16. Palma de Mallorca.  07011. 07011.',
        },
      ],
      details: [
        '50700000 (Servicios de reparación y mantenimiento de equipos de edificios).',
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14345.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14347.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'B24471682.',
          address:
            'POLIGONO INDUSTRIAL LOS AVEZALES, PARCELA 10. OTERO DE LAS DUEÑAS-LEON-.  24123. 24123.',
        },
      ],
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14348.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'B82473125.',
          address:
            'Chile, 4 Edificio 1 oficina 4. Las Rozas (Madrid).  28290. 28290.',
        },
      ],
      details: [
        '50313000 (Mantenimiento y reparación de máquinas de reprografía), 50300000 (Servicios de reparación, mantenimiento y servicios asociados relacionados con ordenadores personales, equipo de oficina, telecomunicaciones y equipo audiovisual) y 50313200 (Servicios de mantenimiento de fotocopiadoras).',
        'Lote 1: 50313000 (Mantenimiento y reparación de máquinas de reprografía), 50300000 (Servicios de reparación, mantenimiento y servicios asociados relacionados con ordenadores personales, equipo de oficina, telecomunicaciones y equipo audiovisual) y 50313200 (Servicios de mantenimiento de fotocopiadoras).',
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14361.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'A48270227.',
          address: 'C/ Santiago de Compostela 12. BILBAO.   España.',
        },
      ],
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14362.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          name: 'A.T. MEDTRA, S.L.',
          nif: 'B39305156.',
          address: 'Isabel Torres, 11 B. SANTANDER.  39011. 39011.',
        },
      ],
      details: [
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14363.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'B29955853.',
          address:
            'POLIGONO INDUSTRIAL SEPES, CALLE LA AMAPOLA, NAVE MELILLA. Melilla.  52005. 52005.',
        },
      ],
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14364.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'B30132724.',
          address:
            'PL. PROFESOR TIERNO GALVAN, 7 - EDIFICIO LIMCAMAR. EL PUNTA. MURCIA.  30009. 30009.',
        },
      ],
      details: ['90911200 (Servicios de limpieza de edificios).'],
      sellingDescription: [
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14365.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14366.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'B26533257.',
          address:
            'CALLE CORDONERA, 2 POLIGONO INDUSTRIAL LA PORTALADA. LA RIOJA.  26006. 26006.',
        },
      ],
      details: ['90911200 (Servicios de limpieza de edificios).'],
      sellingDescription: [
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14367.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'B79184115.',
          address: 'CALLE MARÍA DE MOLINA, 40. MADRID.  28006. 28006.',
        },
      ],
      details: [
        '50000000 (Servicios de reparación y mantenimiento) y 45259000 (Reparación y mantenimiento de instalaciones).',
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14368.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'B81600702.',
          address: 'C/ BRASIL, 17. Madrid.  28020. 28020.',
        },
      ],
      details: [
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14369.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: '',
          address:
            'Pº Marítimo Pablo Ruíz Picaso 1. Pº Marítimo Pablo Ruíz Picaso 1.',
        },
      ],
      details: [
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14372.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14374.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'B59104000.',
          address:
            'Carretera Sabadell a Granollers, Km. 14. LliÇa de Vall.  05185. 05185.',
        },
      ],
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14375.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'B02272490.',
          address: 'Carretera de Mahora Km 3,200. Albacete.  02006. 02006.',
        },
      ],
      details: [
        '50700000 (Servicios de reparación y mantenimiento de equipos de edificios).',
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14376.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14377.pdf',
    },
  },
  {
    content: {
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14378.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          ...
          nif: 'A28838704.',
          address: 'Calle Ricardo Ortiz, 6. Madrid.   España.',
        },
        {
          name: 'DISTRIBUCIONES CLINICAS S.A.',
          nif: 'A28838704.',
      ...
      details: [
        '33000000 (Equipamiento y artículos médicos, farmacéuticos y de higiene personal), 18141000 (Guantes de trabajo) y 18143000 (Indumentaria de protección).',
        'Lote 1: 33000000 (Equipamiento y artículos médicos, farmacéuticos y de higiene personal), 18141000 (Guantes de trabajo) y 18143000 (Indumentaria de protección).',
        'Lote 2: 33000000 (Equipamiento y artículos médicos, farmacéuticos y de higiene personal), 18141000 (Guantes de trabajo) y 18143000 (Indumentaria de protección).',
        'Lote 3: 33000000 (Equipamiento y artículos médicos, farmacéuticos y de higiene personal), 18141000 (Guantes de trabajo) y 18143000 (Indumentaria de protección).',
        'Lote 4: 18141000 (Guantes de trabajo), 18143000 (Indumentaria de protección) y 33000000 (Equipamiento y artículos médicos, farmacéuticos y de higiene personal).',
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14380.pdf',
    },
  },
  {
    content: {
      ...
      sellers: [
        {
          name: 'IECISA.',
          nif: 'A28855260.',
          address: 'C/ Hermosilla 112. Madrid.  28009. 28009.',
        },
      ],
      details: [
        '50312600 (Mantenimiento y reparación de equipo de tecnología de la información).',
    ...
    metadata: {
      ...
      pdfUrl: '/boe/dias/2020/05/28/pdfs/BOE-B-2020-14381.pdf',
    },
  },
];
